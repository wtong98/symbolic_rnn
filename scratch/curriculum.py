...
class RnnClassifier3D(RnnClassifier):
    def __init__(self, weights=None, emb_size=3, hidden_size=3, **kwargs) -> None:
        nonlinearity = 'relu'
        loss_func = 'mse'
...
# <codecell>
train_dl, test_dl = build_dl(max_bits=7, max_args=1, max_noops=0)

# <codecell>
model = RnnClassifier3D(emb_size=32, hidden_size=256).cuda()
